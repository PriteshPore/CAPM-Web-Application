...
with col1:
    stock_list = st.multiselect(
        "Choose 4 stocks",("TSLA","AAPL","NFLX","MSFT","MGM","AMZN","NVDA","GOOGL"),
...
try:
    ...
    for i in stocks_daily_return.columns:
        if i!= 'Date' and i!= 'SP500':
            b,a = capm_functions.calculate_beta(stocks_daily_return=stocks_daily_return,stock=i)
            beta[i] = b
            alpha[i] = a
    print(beta,alpha)
